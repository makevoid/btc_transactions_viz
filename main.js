...
(function(Opal) {
  ...
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $gvars = Opal.gvars, $module = Opal.module, $hash2 = Opal.hash2, $range = Opal.range, $klass = Opal.klass;
  if ($gvars.window == null) $gvars.window = nil;
  if ($gvars.document == null) $gvars.document = nil;

  Opal.add_stubs(['$convert', '$new', '$on', '$puts', '$inject', '$map', '$/', '$**', '$round', '$transactions=', '$+', '$[]', '$transactions', '$include', '$a', '$div', '$params', '$tx_url', '$after_mount', '$define_state', '$h3', '$p', '$present', '$each_with_index', '$render', '$create_element', '$to_n', '$body']);
...
if (o == null) o = nil;
  ...
  (function($base, $super) {
    ...
    return (def.$render = function() {
      ...
      return ($a = ($b = self).$div, $a.$$p = (TMP_8 = function(){var self = TMP_8.$$s || this, $a, $b, TMP_9, $c, TMP_13;

      ($a = ($b = self).$div, $a.$$p = (TMP_9 = function(){var self = TMP_9.$$s || this, $a, $b, TMP_10, $c, TMP_11, $d, TMP_12;

        ($a = ($b = self).$h3, $a.$$p = (TMP_10 = function(){var self = TMP_10.$$s || this;

          return "Transactions"}, TMP_10.$$s = self, TMP_10), $a).call($b);
          ($a = ($c = self).$p, $a.$$p = (TMP_11 = function(){var self = TMP_11.$$s || this;

          return "realtime transactions visualizer, bitcoin network"}, TMP_11.$$s = self, TMP_11), $a).call($c);
          return ($a = ($d = self).$p, $a.$$p = (TMP_12 = function(){var self = TMP_12.$$s || this;

          return "opal, react, css3, websockets, bitcoin, blockchain, blockchain.com, bitcoind"}, TMP_12.$$s = self, TMP_12), $a).call($d);}, TMP_9.$$s = self, TMP_9), $a).call($b, $hash2(["className"], {"className": "header"}));
        return ($a = ($c = self).$div, $a.$$p = (TMP_13 = function(){var self = TMP_13.$$s || this, $a, $b, TMP_14;

        return ($a = ($b = self.$transactions().$each_with_index()).$map, $a.$$p = (TMP_14 = function(tx, idx){var self = TMP_14.$$s || this;
if (tx == null) tx = nil;if (idx == null) idx = nil;
          return self.$present($scope.get('Transaction'), $hash2(["tx", "key"], {"tx": tx, "key": tx['$[]']("hash")}))}, TMP_14.$$s = self, TMP_14), $a).call($b)}, TMP_13.$$s = self, TMP_13), $a).call($c, $hash2(["className"], {"className": "tx_list"}));}, TMP_8.$$s = self, TMP_8), $a).call($b);
    }, nil) && 'render';
  })(self, null);
